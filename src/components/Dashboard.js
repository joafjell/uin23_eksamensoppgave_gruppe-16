...
export default function Dashboard(){ 
    ...
    const shortGameList = randomGames.slice(0, 3) //Brukte en kode på denne siden https://stackoverflow.com/questions/34883068/how-to-get-first-n-number-of-elements-from-an-array som inspirasjon
    ...
    const shortenedFavourites = favourite.slice(0, 2) //Brukte en kode på denne siden https://stackoverflow.com/questions/34883068/how-to-get-first-n-number-of-elements-from-an-array som inspirasjon

    const libraryGames = mygames.slice(0, 4) //Brukte en kode på denne siden https://stackoverflow.com/questions/34883068/how-to-get-first-n-number-of-elements-from-an-array som inspirasjon
